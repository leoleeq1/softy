...
class Transform {
 public:
  ...
  void SetLocalPositionRotation(v3f position, quaternion rotation) noexcept;
  void SetWorldPositionRotation(v3f position, quaternion rotation) noexcept;
...
inline mat4 Transform::GetRotationMatrix(quaternion rotation) noexcept {
  return static_cast<mat4>(rotation);
}
